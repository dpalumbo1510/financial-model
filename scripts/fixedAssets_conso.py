...
def calculate_fixed_assets(fixed_assets_source, model_generation_date):
    ...
    for asset in fixed_assets_df.index:
        ...
        useful_life_in_months = int((fixed_assets_df['useful_life'][asset]) * 12)
    ...
    for asset in current_assets_df.index:
        ...
        asset_name = current_assets_df['name'][asset]
    ...
    list_bridge_df = pd.DataFrame(
        amortization_list, 
        columns = ['asset_id', 'asset_name', 'amort_period', 'amort_amount']
    )
