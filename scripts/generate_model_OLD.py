...
#TODO PASAR A EXCEL - Parametros financieros y fiscales: 
...
#TODO CREAR BASE DE DATOS Y APUNTAR A ELLA - Carga de la información sobre las plantas:
#TODO Que el usuario seleccione sobre cuales plantas quiere modelizar.
#TODO Se debe almacenar las plantas seleccionadas. Si es mas de una, debe
#TODO incluir la pestaña "Conso_M_Template". En caso de que no, la debe ignorar.  
...
#TODO TODOS LOS INPUTS SE DEBEN MOVER A BBDD - Carga de data externa:
